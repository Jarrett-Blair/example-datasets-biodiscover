...
- A presentation and online materials (especially READMEs under `datasets/`) to disseminate and demystify working with standards
- Scripts and tools to map data to, and read data from, Camtrap DP/InsectAI (also under `datasets/`)
